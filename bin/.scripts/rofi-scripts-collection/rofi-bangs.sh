...
# open bookmarks
COMMANDS["bookmarks"]="~/.local/bin/.scripts/rofi-scripts-collection/rofi-surfraw-bookmarks.sh"
LABELS["bookmarks"]=""

# search local files
COMMANDS["locate"]="~/.local/bin/.scripts/rofi-scripts-collection/rofi-locate.sh"
LABELS["locate"]=""

# open custom web searches
COMMANDS["websearch"]="~/.local/bin/.scripts/rofi-scripts-collection/rofi-surfraw-websearch.sh"
LABELS["websearch"]=""

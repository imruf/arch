...
reset=$(tput sgr0)
colw=$(tput setaf 15)
colgo=$(tput setaf 172)
colc=$(tput setaf 38)
colgr=$(tput setaf 78)
coly=$(tput setaf 226)
PS1='\[$bold\]\[$colw\][\[$reset\]\[$bold\]\[$colgo\]\u\[$reset\]\[$bold\]\[$colw\]@\[$reset\]\[$bold\]\[$colc\]\h\[$reset\]\[$bold\]\[$coly\]  \[$reset\]\[$bold\]\[$colgr\]\w\[$reset\]\[$bold\]\[$colw\]]\[$reset\]\[$bold\]\[$colc\] >> \[$reset\]'

...
class VRedgifMIMEParser(BaseMIMEParser):
    ...
    redgif mime
    """
    pattern = re.compile(r'http://v3\.redgifs\.com/watch/.+$|https://v3\.redgifs\.com/watch/.+$|http://www\.redgifs\.com/watch/.+$|https://www\.redgifs\.com/watch/.+$|https://redgifs\.com/watch/.+$')
